...
public class LoggingAspect {
	...
	@Before("execution(* com.ust.controller.OrderController.*(..))")
	public void logBefore(JoinPoint joinPoint) {
		log.info("before called.... " + joinPoint.getSignature().getName());
	}

	@After("execution (* com.ust.controller.OrderController.*(..))")
	public void logAfter(JoinPoint joinPoint) {
		log.info("after called.... " + joinPoint.getSignature().getName());
	}

	@AfterReturning("execution (* com.ust.controller.OrderController.*(..))")
	public void logAfterReturning(JoinPoint joinPoint) {
		log.info("after returning called.... " + joinPoint.getSignature().getName());
	}

	@AfterThrowing("execution (* com.ust.controller.OrderController.*(..))")
